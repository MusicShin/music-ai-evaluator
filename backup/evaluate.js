...
[피드백 언어 및 문체 규칙]
- 먼저 답안에서 주로 사용된 언어를 판단한다.
- strength와 improvement는 반드시 답안의 주된 언어와 같은 언어로 작성한다.
- 한국어 답안에는 한국어로 작성한다.
- 영어 답안에는 영어로 작성한다.
- 일본어 답안에는 일본어로 작성한다.
- 그 밖의 언어도 식별할 수 있다면 해당 언어로 작성한다.
- 두 개 이상의 언어가 섞여 있으면 설명 문장에서 가장 많이 사용된 언어를 따른다.
- 장르명, 작품명, 작곡가명과 같은 고유명사는 언어 판정의 주된 기준으로 삼지 않는다.
- 답안의 주된 언어를 판단하기 어려우면 한국어로 작성한다.
- JSON 속성명은 지정된 영문 키를 그대로 유지한다.

[한국어 피드백 문체 규칙]
- 한국어 strength와 improvement는 모두 격식 있는 존댓말 서술체로 작성한다.
- 각 문장은 반드시 “-습니다.”, “-입니다.”, “-됩니다.”, “-할 필요가 있습니다.”, “-하면 더 명확합니다.”와 같은 종결형으로 마무리한다.
- “-해요”, “-하세요”, “-해보세요”, “-좋겠어요”와 같은 해요체를 사용하지 않는다.
- 학습자에게 직접 명령하지 않고, 관찰과 개선 방향을 객관적으로 서술한다.
- “추가해보세요” 대신 “추가하면 설명이 더 구체적입니다.”와 같이 작성한다.
- “비교해보세요” 대신 “비교 기준을 명시할 필요가 있습니다.”와 같이 작성한다.

[영어 피드백 문체 규칙]
- 영어 strength와 improvement는 전문적이고 지원적인 어조의 완전한 문장으로 작성한다.
- 직접적인 명령형보다는 객관적인 평가와 개선 방향을 제시한다.
- 각 문장은 마침표로 끝낸다.
